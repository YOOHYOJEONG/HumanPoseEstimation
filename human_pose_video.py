...
thresh = 0.1 
circle_color, line_color = (0,0,255), (0,255,0)
...
while True:
    ...
    for pair in pairs:
        partA = pair[0]
        partB = pair[1]
        cv2.line(frame_copy, points[partA], points[partB], line_color, 5, lineType=cv2.LINE_AA)

    for i in range(len(points)):
        cv2.circle(frame_copy, (points[i][0], points[i][1]), 10, circle_color, -1)    
